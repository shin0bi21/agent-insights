...
Feature documents describe current user-visible behavior across the browser, localhost API, persistence, provider, evaluator, and report boundaries. Architecture explains system-wide ownership; development guides explain how to change it.
...
These documents describe product behavior, not a required layout for attached repositories.
