...
Automation readiness estimates how reliably an agent can understand, change, verify, and explain a repository. It is not a score for copying this workbench's folder structure.
